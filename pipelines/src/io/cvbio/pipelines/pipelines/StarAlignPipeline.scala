...
import io.cvbio.pipelines.tasks.misc.MoveBam
import io.cvbio.pipelines.tasks.star.StarAlign
import io.cvbio.pipelines.tasks.star.StarAlign.{IntronMotifFilter, IntronStrandFilter, OutputFilterType, TwoPassMode}
